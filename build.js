...
async function build() {
  ...
  const assetsToCopy = ['images', 'admin', 'content', 'content.default.js', 'templates.js', 'favicon.ico', 'favicon-32.png', 'apple-touch-icon.png', 'robots.txt', 'sitemap.xml', 'googlec5a8428c6a8d807b.html', 'privacy.html'];
